classdef Control < handle
    ...
    methods
        ...
        function runGeneralTest(controler, app)
            ...
            postSettings = struct( ...
                'enabled', ...
                logical(definition.camera.postProcessEnabled), ...
                'samplingPeriod', ...
        ...
        function startTestForTesting(controler, commands, postSettings, recordEnabled, testKind)
    ...
    methods (Access = private)
        function startTest(controler, app, commands, postSettings, recordEnabled, testKind)
            ...
            if recordEnabled && ~controler.camera.connected
                error('Control:CameraDisconnected', ...
