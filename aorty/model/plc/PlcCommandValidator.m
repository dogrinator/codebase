    ...
    methods (Static)
        ...
        function test(command, statusNow)
            ...
            required = {'includePreTest', 'preTestOnly', ...
                ...
                'preUnloadToStart', 'preTestRate', 'preTestHoldTime', ...
                'testRate', 'forceHoldTime', 'cycleCount', ...
            ...
            if ~isfinite(command.testRate) || command.testRate <= 0 || ...
                    ~isfinite(command.forceHoldTime) || ...
                    command.forceHoldTime < 0
                error('PLC:InvalidTestCommand', ...
                    ['Movement speed must be positive and force hold ' ...
            ...
            if command.includePreTest
                preValues = [command.preloadValue, ...
                    ...
                    command.preTestRate, command.preTestHoldTime];
                if ~PlcCommandValidator.isIntegerInRange( ...
